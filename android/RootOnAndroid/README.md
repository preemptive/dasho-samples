...
This [sample app](../README.md#sample_desc) for Android&trade; illustrates the use of `RootCheck` and `RootResponse` in _PreEmptive Protection™ DashO™ for Android & Java_.

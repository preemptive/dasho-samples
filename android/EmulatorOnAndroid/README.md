...
This [sample app](../README.md#sample_desc) for Android™ illustrates the use of `EmulatorCheck` and `EmulatorResponse` in _PreEmptive Protection™ DashO™ for Android & Java_.

...
This [sample app](../README.md#sample_desc) for Android&trade; illustrates the use of `TamperCheck` and `TamperResponse` in _PreEmptive Protection™ DashO™ for Android & Java_.

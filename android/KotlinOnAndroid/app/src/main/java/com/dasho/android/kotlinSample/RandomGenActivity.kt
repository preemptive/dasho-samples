...
class RandomGenActivity : Activity(), OnClickListener {
    ...
    private lateinit var genNumber: TextView
    private lateinit var rndMaxNum: EditText
    private lateinit var rndMinNum: EditText
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        genNumber = findViewById(R.id.genNumber)
        rndMaxNum = findViewById(R.id.rndMaxNum)
        rndMinNum = findViewById(R.id.rndMinNum)

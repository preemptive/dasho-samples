...
class FibActivity : Activity(), OnClickListener {
    ...
    private lateinit var calcFibBtn: Button
    private lateinit var calcFibRes: TextView
    private lateinit var fibSeqNum: EditText
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        calcFibBtn = findViewById(R.id.calcFibBtn)
        calcFibRes = findViewById(R.id.calcFibRes)
        fibSeqNum = findViewById(R.id.fibSeqNum)
